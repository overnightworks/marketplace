...
- Fix exactly the named findings, including any the reviewer marked `follow-up (fix in place)` — resolve those in this same batch, not as a separate follow-up card.
